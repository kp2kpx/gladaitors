...
const STATIC_TAUNTS = [
  ...
  "Your gladiator fought bravely. Not well, but bravely.",
  "The arena floor has been cleaned. Your dignity cannot be recovered.",
  "Even your own gladiator is embarrassed right now.",
  ...
  "Somewhere, a better gladiator is laughing.",
  ...
  "Some gladiators are born for greatness. Keep trying.",
  ...
  "Somewhere your gladiator is writing an apology letter.",
